<?xml version="1.0" ?><!-- generated with COPASI 4.24 (Build 197) (http://www.copasi.org) at 2019-05-16 15:56:03 UTC --><?oxygen RNGSchema="http://www.copasi.org/static/schema/CopasiML.rng" type="xml"?><COPASI copasiSourcesModified="0" versionDevel="197" versionMajor="4" versionMinor="24" xmlns="http://www.copasi.org/static/schema">
  <ListOfFunctions>
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5003" name="k1" value="0.105905"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5002" name="k1" value="0.851233"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" scalingCompartment="CN=Root,Model=New Model_1,Vector=Compartments[compartment]" unitType="Default">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5001" name="k1" value="0.74719"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" scalingCompartment="CN=Root,Model=New Model_1,Vector=Compartments[compartment]" unitType="Default">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5000" name="k1" value="0.740023"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" scalingCompartment="CN=Root,Model=New Model_1,Vector=Compartments[compartment]" unitType="Default">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model_1,Vector=Values[k_predator_breeds]" simulationType="fixed" type="ModelValue" value="0.1059049082388489"/>
          <ModelParameter cn="CN=Root,Model=New Model_1,Vector=Values[k_predator_dies]" simulationType="fixed" type="ModelValue" value="0.8512326153680424"/>
          <ModelParameter cn="CN=Root,Model=New Model_1,Vector=Values[k_prey_breeds]" simulationType="fixed" type="ModelValue" value="0.74718986058493497"/>
          <ModelParameter cn="CN=Root,Model=New Model_1,Vector=Values[k_prey_dies]" simulationType="fixed" type="ModelValue" value="0.74002255619905244"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=New Model_1,Vector=Reactions[predator_breeds]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model_1,Vector=Reactions[predator_breeds],ParameterGroup=Parameters,Parameter=k1" simulationType="assignment" type="ReactionParameter" value="0.1059049082388489">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model_1,Vector=Reactions[predator_dies]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model_1,Vector=Reactions[predator_dies],ParameterGroup=Parameters,Parameter=k1" simulationType="assignment" type="ReactionParameter" value="0.8512326153680424">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model_1,Vector=Reactions[prey_breeds]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model_1,Vector=Reactions[prey_breeds],ParameterGroup=Parameters,Parameter=k1" simulationType="assignment" type="ReactionParameter" value="0.74718986058493497">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model_1,Vector=Reactions[prey_dies]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model_1,Vector=Reactions[prey_dies],ParameterGroup=Parameters,Parameter=k1" simulationType="assignment" type="ReactionParameter" value="0.74002255619905244">
              <InitialExpression>
    ...
    <InitialState type="initialState">
      0 6.0221408570000002e+20 6.0221408570000005e+22 1 0.1059049082388489 0.8512326153680424 0.74718986058493497 0.74002255619905244 
    </InitialState>
  </Model>
  <ListOfTasks>
